...
from sklearn import clone, __version__ as sklearn_version
...
from skhubness.neighbors import NeighborhoodComponentsAnalysis
...
@pytest.mark.skipif(condition=LooseVersion(sklearn_version) < LooseVersion('0.22'),
                    reason='numpy types supported from 0.22 onwards')
