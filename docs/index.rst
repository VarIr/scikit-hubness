.. hubness documentation master file, created by
   sphinx-quickstart on Mon Jul  8 13:54:25 2019.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

`hubness`: high-dimensional data mining
=======================================

`hubness` is a Python package for analysis and reduction of hubness
...
The user guide explains how to install the `hubness`, how to analyze your
data sets for hubness, and how to use the package to lift this
*curse of dimensionality*.

You will also find examples how to use `hubness.neighbors` for approximate nearest neighbor search.


.. toctree::
  :maxdepth: 2

  user_guide/hub-toolbox_vs_hubness
...
Find all the information about specific modules and functions of `hubness` in this section.
